...
class ISO4217
{
    ...
    const URUGUAY_PESO_EN_UNIDADES_INDEXADAS_URUIURUI = "UYI";
    ...
    const BOND_MARKETS_UNIT_EUROPEAN_MONETARY_UNIT_EMU = "XBB";

    
    const BOND_MARKETS_UNIT_EUROPEAN_UNIT_OF_ACCOUNT_EUA = "XBC";

    
    const BOND_MARKETS_UNIT_EUROPEAN_UNIT_OF_ACCOUNT_EUA_2 = "XBD";
